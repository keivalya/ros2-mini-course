...
setup(
    ...
    zip_safe=True,
    maintainer="ros",
    maintainer_email="keivalya.pandya@bvmengineering.ac.in",
    description="ROS2 Mini Course is a 5 day course where we cover ROS2 essentials!",
    license="Apache-2.0",
